...
dictCoefficients = {'Vision':    [1.0, 0.98, 0.89, 0.84, 0.75, 0.61],
                    'Hearing':     [1.0, 0.95, 0.89, 0.80, 0.74, 0.61],
                    'Speech':    [1.0, 0.94, 0.89, 0.81, 0.68],
                    'Ambulation':   [1.0, 0.93, 0.86, 0.73, 0.65, 0.58],
                    'Dexterity':   [1.0, 0.95, 0.88, 0.76, 0.65, 0.56],
                    'Emotion':   [1.0, 0.95, 0.85, 0.64, 0.46],
                    'Cognition':   [1.0, 0.92, 0.95, 0.83, 0.60, 0.42],
                    'Pain':   [1.0, 0.96, 0.90, 0.77, 0.55]}
...
def get_score(vision, hearing, speech, ambulation, dexterity, emotion, cognition, pain):
    ...
    # subtract the coefficients of dimensions
